...
impl Index {
    ...
    pub fn reload_index(&mut self) -> Result<u16, IndexError> {
        ...
        self.index_file.seek(SeekFrom::Start(entry_read_start_bytes)).map_err(|e| {
            error!("{}", e);
     ...
     */
    pub fn return_entry_details_by_offset(&self, offset: usize) -> Result<(u64, usize), IndexError> {
